...
Graceful Boundaries: a spec for how APIs communicate limits to humans and agents. Discovery before failure. Structured refusal with reasons. Constructive guidance instead of bare 429s. v1.5 adds adoption tooling, schemas, middleware, and CI checks.
...
Version 1.5 keeps the conformance model stable and adds an npx checker, JSON Schemas, middleware examples, CI gates, an agent compliance suite, and adopter validation tooling.
