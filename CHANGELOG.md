...
- RFC 9116 `/.well-known/security.txt` naming security@paice.work, with a test for required fields, expiry, and agreement with `SECURITY.md`.

### Fixed
- `SECURITY.md` pointed reporters to GitHub private vulnerability reporting, which is not enabled for this repository. It now names security@paice.work.
