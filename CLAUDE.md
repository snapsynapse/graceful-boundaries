...
- Spec version **1.5.3** (see `CHANGELOG.md`; pending work is recorded under `## Unreleased`). 1.5.x is an adoption-tooling line with no normative spec changes since 1.3/1.4 introduced Action Boundaries and the expanded limit taxonomy.
