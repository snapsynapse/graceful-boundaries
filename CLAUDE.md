...
- `evals/test-*.js` — unit tests (104 tests across 6 files)
...
- Shared functions (`checkRefusalBody`, `checkLimitsBody`, `checkProactiveHeaders`, `checkDedupResponse`, `isStableErrorValue`, `assessLevel`) are in `check.js` and exported.
